...
modo.classes.PostBox.components.UI = function(rootNode, superClass){
	...
	var bindEvents = function(){
        ...
        rootNode.one('click', '#create-snapshot-btn', showSnapshotCreateOptions);
    ...
    var showSnapshotCreateOptions = function(){

        var li = _$(this).parents('#postbox-snapshot-content');
        _$(this).parent().toggle();
        li.find('.snapshot-content-input').toggle();
    ...
    var populateStandardsDropdown = function (event){
        ...
        var pb          = _$(this).parentsUntil('.postbox-content'),
            dropdown    = pb.find('.snapshot-dropdown'),
            content     = dropdown.closest('.snapshot-content-input'),
            bottom      = pb.find('.snapshot-bottom-content');
            dropdown.select2({
            ...
            ajax: {
                ...
                data: function (term, page) {
                    var receivers = content.find('div.suggest-receiver'),
                        l = receivers.length;
                        var groups = [];
                    ...
                    var grade = bottom.find("#grades option:selected").attr('value');

                    if (grade == t._('grade-selector')){
                        grade = '';
                    }

                    var subject = bottom.find('.btn-group .btn-primary.active').attr('subject');
    ...
    function formatSelection(data) {
        ...
        return data.statement_code_short;
